...
public class ExceptionHandlerAdvice{
    ...
    public ResponseEntity<ErrorDTO> _409_Conflict(DataIntegrityViolationException ex, HttpServletRequest request)
    {

        ErrorDTO errorDTO = new ErrorDTO(HttpStatus.CONFLICT.value(),HttpStatus.CONFLICT.getReasonPhrase(), "Conflict Detected: Name of this entity already exists",request.getRequestURI());
